...
@.str1 = private unnamed_addr constant [6 x i8] c"ex2.c\00", section "llvm.metadata"
...
if.else:                                          ; preds = %entry
  store i32 2, i32* %b, align 4, !dbg !28
  br label %if.end

if.end:                                           ; preds = %if.else, %if.then
  %1 = load i32* %a, align 4, !dbg !30
  %tobool2 = icmp ne i32 %1, 0, !dbg !30
  br i1 %tobool2, label %if.then3, label %if.else4, !dbg !30

if.then3:                                         ; preds = %if.end
  store i32 1, i32* %c, align 4, !dbg !32
  br label %if.end5, !dbg !34

if.else4:                                         ; preds = %if.end
  store i32 2, i32* %d, align 4, !dbg !35
  br label %if.end5
...
!0 = metadata !{i32 786449, metadata !1, i32 12, metadata !"clang version 3.5.0 (tags/RELEASE_350/final)", i1 false, metadata !"", i32 0, metadata !2, metadata !2, metadata !3, metadata !2, metadata !2, metadata !"", i32 1} ; [ DW_TAG_compile_unit ] [/home/sxl463/working/pdg-for-robert/test/pub-priv/ex2/ex2.c] [DW_LANG_C99]
!1 = metadata !{metadata !"ex2.c", metadata !"/home/sxl463/working/pdg-for-robert/test/pub-priv/ex2"}
!2 = metadata !{}
...
!5 = metadata !{i32 786473, metadata !1}          ; [ DW_TAG_file_type ] [/home/sxl463/working/pdg-for-robert/test/pub-priv/ex2/ex2.c]
...
!24 = metadata !{i32 786443, metadata !1, metadata !4, i32 6, i32 5, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/sxl463/working/pdg-for-robert/test/pub-priv/ex2/ex2.c]
!25 = metadata !{i32 8, i32 3, metadata !26, null} ; [ DW_TAG_imported_declaration ]
!26 = metadata !{i32 786443, metadata !1, metadata !24, i32 7, i32 2, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/sxl463/working/pdg-for-robert/test/pub-priv/ex2/ex2.c]
!27 = metadata !{i32 9, i32 2, metadata !26, null}
!28 = metadata !{i32 12, i32 3, metadata !29, null}
!29 = metadata !{i32 786443, metadata !1, metadata !24, i32 11, i32 2, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/sxl463/working/pdg-for-robert/test/pub-priv/ex2/ex2.c]
!30 = metadata !{i32 15, i32 5, metadata !31, null}
!31 = metadata !{i32 786443, metadata !1, metadata !4, i32 15, i32 5, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/sxl463/working/pdg-for-robert/test/pub-priv/ex2/ex2.c]
!32 = metadata !{i32 17, i32 3, metadata !33, null}
!33 = metadata !{i32 786443, metadata !1, metadata !31, i32 16, i32 2, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/sxl463/working/pdg-for-robert/test/pub-priv/ex2/ex2.c]
!34 = metadata !{i32 18, i32 2, metadata !33, null}
!35 = metadata !{i32 21, i32 3, metadata !36, null}
!36 = metadata !{i32 786443, metadata !1, metadata !31, i32 20, i32 2, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/sxl463/working/pdg-for-robert/test/pub-priv/ex2/ex2.c]
!37 = metadata !{i32 23, i32 1, metadata !4, null}
